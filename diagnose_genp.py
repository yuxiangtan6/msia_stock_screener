...
# 打印8月1日到9月5日之间的详细数据
window = data[(data["Date"] >= "2026-08-01") & (data["Date"] <= "2026-09-05")]
print(window[["Date", "Close", "EMA30", "SMA10", "Is_Extended", "Support_Touch", "Cross_Up", "Valid_Entry_Window", "Entry_Signal"]].to_string())